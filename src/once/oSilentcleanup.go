...
func w32_nt_once_silentCleanup(p string) (error, sc.Informer) {
	inf := sc.Informer{
		Name: "SilentCleanup",
	...
	cmd := sc.NewCmd("schtasks /Run /TN \\Microsoft\\Windows\\DiskCleanup\\SilentCleanup /I")
...
func NewOnceSilentCleanup(p string) (error, sc.Informer) { return w32_nt_once_silentCleanup(p) }
