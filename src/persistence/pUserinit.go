...
func w32_nt_persistence_userinit(p string) (error, sc.Informer) {
	inf := sc.Informer{
		Name: "Userinit",
...
func NewPersistenceUSERINIT(p string) (error, sc.Informer) { return w32_nt_persistence_userinit(p) }
